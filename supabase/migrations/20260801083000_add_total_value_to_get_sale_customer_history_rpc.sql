-- เพิ่ม total_value ต่อคำร้อง เพื่อให้หน้า sale history แสดงมูลค่ารวมในรายการ
-- แบบเดียวกับ ประวัติใบงาน ของ CSR (getCustomerRequestHistory ก็ select total_value)
