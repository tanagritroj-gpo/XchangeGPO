-- province ไม่เคยอยู่ใน INSERT column list ของฟังก์ชันนี้เลย ทำให้ requests.province
-- ไม่มีทางถูกเซ็ตแม้ caller จะส่งค่ามาก็ตาม เพิ่มคอลัมน์เดียว ที่เหลือคง body เดิมทุก
-- บรรทัด (ไม่แก้ GRANT/REVOKE เพราะสิทธิ์เดิมของฟังก์ชันนี้ไม่เปลี่ยน)
