    ...
    <div className="min-h-screen bg-background">
      ...
      <div className="max-w-6xl mx-auto px-4 md:px-6 py-4 md:py-8">
        <section className="bg-white rounded-2xl md:rounded-3xl shadow-md border border-border overflow-hidden">
          ...
          {/* Section header */}
          <div className="flex items-center gap-3 px-4 md:px-7 py-4 md:py-5 border-b border-border"
            ...
            <div>
              <h2 className="text-sm font-black text-foreground">จัดการงานขนส่ง</h2>
              <p className="text-xs text-muted-foreground">{requests.length} รายการ</p>
            </div>
          </div>
          ...
          {requests.length === 0 ? (
            <div className="py-10 md:py-14 text-center">
              ...
              <p className="text-sm text-muted-foreground font-medium">ไม่มีงานขนส่งในระบบ</p>
            </div>
          ) : (
                  ...
                  <div key={req.id} className="hover:bg-slate-50/40 transition-colors">
                    ...
                    <div className="md:hidden px-4 py-4 space-y-3">
                      ...
                      <div className="flex gap-2">
                        {isReqProcessing ? (
                          <div className="flex-1 flex items-center justify-center gap-2 py-2.5 text-muted-foreground">
