...
import { getRequestTrackingForManager } from '@/app/actions/tracking-actions';
...
// (getRequestTrackingForManager ใน tracking-actions.ts ไม่ filter submission_channel เลย)
...
// action getRequestTrackingForManager ก็ยืนยันซ้ำอิสระอีกชั้นเสมอ ไม่พึ่งแค่ page guard
export default function ManagerTrackingPage() {
  ...
  return (
    <div className="relative min-h-screen bg-gradient-to-b from-[#FBF6E8] via-[#F8F2DF] to-[#F1E7C8]">
      ...
      {/* ══ Top Bar — เข้าชุดกับหน้า staff-approvals ══ */}
      ...
      <div className="relative z-10">
        <TrackingDetailView
          fetchFn={getRequestTrackingForManager}
          heading="Track & Trace"
