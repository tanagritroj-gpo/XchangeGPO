...
// ═══════════════════════════════════════════════════════════════════════════
//  หน้า "/guide" — คู่มือการใช้งานฉบับสาธารณะ (ไม่ต้องเข้าสู่ระบบ)
//  — โครง/เนื้อหาเดียวกับคู่มือฝั่งเข้าสู่ระบบ (app/(authenticated)/customer/manual)
//    แต่ปรับสำนวนให้เหมาะกับผู้ที่ยังไม่ได้ลงทะเบียน: CTA ไปหน้าเข้าสู่ระบบ/ลงทะเบียน,
//    ฟีเจอร์หลังเข้าสู่ระบบเขียนเป็น "สิ่งที่ทำได้หลังเข้าสู่ระบบ"
//  — UI ตาม design.md (Option B): accent เดียว, rounded-md/lg, border 1px,
//    ไม่มี gradient/blob; สีเชิงความหมาย (amber/blue/emerald/red) เฉพาะแผนภาพสถานะ
//  — หน้านี้ standalone (ไม่มี layout ครอบ) จึงมี topbar + container ของตัวเอง
// ═══════════════════════════════════════════════════════════════════════════
...
const FAQS = [
  ...
  {
    q: 'ลงทะเบียนแล้วรอนานแค่ไหนถึงใช้งานได้',
    a: 'หลังกรอกข้อมูลลงทะเบียนครบและลงลายมือชื่อแล้ว เจ้าหน้าที่จะตรวจสอบและอนุมัติภายใน 1–2 วันทำการ จากนั้นเข้าสู่ระบบได้ทันที',
  },
  {
    ...
    <main className="min-h-screen bg-background font-sans text-foreground">
      ...
      <div className="border-b border-border bg-card">
        <div className="mx-auto max-w-5xl px-4 py-3 md:px-6">
          <Link
            href="/"
            className="inline-flex items-center gap-1.5 rounded-md px-2 py-1 -ml-2 text-sm font-medium text-slate-600 transition-colors hover:text-primary focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-primary focus-visible:ring-offset-2"
          >
      ...
      <div className="mx-auto max-w-5xl space-y-10 px-4 py-8 md:px-6">
        ...
        <section className="rounded-lg bg-primary p-6 text-primary-foreground sm:p-8">
          <div className="flex items-center gap-2 text-[11px] font-bold uppercase tracking-[0.18em] text-primary-foreground/70">
            ...
            GPO Xchange Portal · คู่มือการใช้งาน
          </div>
          <h1 className="mt-3 text-2xl font-bold leading-tight sm:text-3xl">
            ยื่นคำร้องคืน/แลกเปลี่ยนสินค้าออนไลน์ ครบทุกขั้นตอน
          </h1>
          <p className="mt-2 max-w-2xl text-sm leading-relaxed text-primary-foreground/80">
            ระบบยื่นคำร้องคืนสินค้า/ยาแบบครบวงจรขององค์การเภสัชกรรม — ยื่นเรื่อง เซ็นเอกสาร รับไฟล์ PDF
            และติดตามสถานะได้ด้วยตัวเอง ไม่ต้องเดินทางหรือรอสายโทรศัพท์ อ่านคู่มือฉบับนี้เพื่อเข้าใจทุกขั้นตอนก่อนเริ่มใช้งาน
          </p>
        ...
        {/* ─────────────── 2. ประเภทการคืน ─────────────── */}
        <section id="types" className="scroll-mt-20 space-y-5">
          <SectionHeader
            icon={Repeat}
          ...
          <div className="flex items-start gap-2.5 rounded-lg border border-amber-200 bg-amber-50 p-4">
            ...
            <p className="text-xs leading-relaxed text-amber-900">
              <span className="font-bold">ยังไม่แน่ใจ?</span> ดูเงื่อนไขและรายการสินค้าที่ไม่รับคืนได้ที่หัวข้อ
              <a href="#policy" className="mx-1 font-bold text-amber-900 underline underline-offset-2">หลักเกณฑ์การคืน</a>
              ด้านล่าง หรือติดต่อเจ้าหน้าที่ก่อนยื่นได้เสมอ
            </p>
          </div>
        </section>

        {/* ─────────────── 3. เริ่มต้นใช้งาน ─────────────── */}
        <section id="start" className="scroll-mt-20 space-y-5">
          <SectionHeader
            icon={LogIn}
          ...
          <Link
            href="/auth/customer-register"
            className="inline-flex items-center gap-1.5 rounded-md bg-primary px-4 py-2.5 text-sm font-bold text-primary-foreground transition-colors hover:bg-primary/90"
          >
            <UserPlus className="h-4 w-4" strokeWidth={2.5} aria-hidden="true" />
            ไปหน้าลงทะเบียน
        ...
        <section id="form" className="scroll-mt-20 space-y-5">
          <SectionHeader
            icon={FileEdit}
            eyebrow="ยื่นคำร้อง"
            title="แบบฟอร์มออนไลน์ 5 ขั้นตอน"
            intro="หลังเข้าสู่ระบบ กรอกแบบฟอร์ม 5 ขั้นตอน ทุกขั้นมีการตรวจสอบข้อมูลเบื้องต้นให้อัตโนมัติ ข้อมูลจะไม่หายถ้ากดย้อนกลับไปแก้"
          />
        ...
        {/* ─────────────── 5. หลังยื่นสำเร็จ ─────────────── */}
        <section id="after" className="scroll-mt-20 space-y-5">
          <SectionHeader
            icon={CheckCircle2}
        ...
        {/* ─────────────── 6. ติดตามสถานะ ─────────────── */}
        <section id="tracking" className="scroll-mt-20 space-y-5">
          <SectionHeader
            icon={Search}
            eyebrow="ติดตามสถานะ"
            title="รู้ทุกความเคลื่อนไหวของคำร้อง"
            intro="คำร้องจะเดินผ่านสถานะ 4 ขั้นแบบเรียลไทม์ ดูได้ทั้งแบบไม่ต้องเข้าสู่ระบบ (แค่กรอกเลขอ้างอิง) และแบบเข้าสู่ระบบเพื่อดูรายละเอียดเต็ม"
          />
          ...
          <div className="flex flex-wrap items-center gap-3">
            ...
            >
              <Search className="h-4 w-4" strokeWidth={2.5} aria-hidden="true" />
              ไปหน้าติดตามสถานะ (ไม่ต้องเข้าสู่ระบบ)
              <ArrowRight className="h-3.5 w-3.5" strokeWidth={2.5} aria-hidden="true" />
            </Link>
          </div>
        ...
        {/* ─────────────── 7. หลังเข้าสู่ระบบ ทำอะไรได้เพิ่ม ─────────────── */}
        <section id="more" className="scroll-mt-20 space-y-5">
          <SectionHeader
            icon={UserCog}
            eyebrow="หลังเข้าสู่ระบบ"
            title="สิ่งที่ทำได้เพิ่มเมื่อเข้าสู่ระบบด้วยบัญชีของคุณ"
          />
          <div className="grid gap-4 sm:grid-cols-2">
            <Card>
              <div className="flex items-center gap-2.5">
              ...
              <p className="mt-2 text-xs leading-relaxed text-slate-600">
                คำร้องทั้งหมดที่คุณเคยยื่น กรองตามประเภทงานและสถานะได้ พร้อมสรุปยอด และปุ่มเปิดดูเอกสาร PDF ของแต่ละคำร้อง
              </p>
            </Card>
            <Card>
              <div className="flex items-center gap-2.5">
            ...
            <Card>
              <div className="flex items-center gap-2.5">
                ...
                <h3 className="text-sm font-bold text-foreground">จัดการบัญชีของคุณเอง</h3>
              </div>
              <p className="mt-2 text-xs leading-relaxed text-slate-600">
                เปลี่ยนรหัสผ่าน (อุปกรณ์อื่นที่ค้างไว้จะถูกออกจากระบบ) และแก้ชื่อ/เบอร์โทร/ตำแหน่งของผู้ติดต่อได้เอง —
                ส่วนอีเมลผูกกับ Google แก้ผ่านเจ้าหน้าที่ CSR
              </p>
            </Card>
            <Card>
              <div className="flex items-center gap-2.5">
                ...
                <h3 className="text-sm font-bold text-foreground">ผู้ช่วย GPO Spark</h3>
              </div>
              <p className="mt-2 text-xs leading-relaxed text-slate-600">
                ปุ่มผู้ช่วยลอยอยู่มุมขวาล่างทุกหน้าหลังเข้าสู่ระบบ ตอบคำถามเรื่องเงื่อนไขการคืนและวิธีใช้งานได้ทันที
                (ไม่เข้าถึงข้อมูลคำร้องหรือข้อมูลส่วนตัวของคุณ)
              </p>
            </Card>
          </div>
        </section>

        {/* ─────────────── 8. หลักเกณฑ์การคืน (สรุป) ─────────────── */}
        <section id="policy" className="scroll-mt-20 space-y-5">
          <SectionHeader
            icon={ScrollText}
            eyebrow="หลักเกณฑ์การคืน"
            title="เงื่อนไขสำคัญก่อนยื่นคำร้อง"
            intro="สรุปจากประกาศขององค์การเภสัชกรรม — โปรดตรวจสอบก่อนเตรียมสินค้าเพื่อยื่นคำร้อง"
          />
          ...
          <p className="text-xs leading-relaxed text-slate-500">
            หลังเข้าสู่ระบบ สามารถเปิดอ่านหลักเกณฑ์การรับคืนผลิตภัณฑ์ฉบับเต็มได้จากเมนูภายในระบบ
          </p>
        </section>
        ...
        <section id="contact" className="scroll-mt-20">
          <div className="rounded-lg border border-border bg-card p-6">
            ...
            <p className="mt-2 text-sm leading-relaxed text-slate-600">
              หากพบปัญหาการใช้งานหรือมีข้อสงสัยเพิ่มเติม ติดต่อทีมงาน GPO สาขาภาคใต้ ได้ตามช่องทางนี้
            </p>
        ...
        {/* ── กลับสู่หน้าหลัก (ท้ายเพจ) ── */}
        <div className="flex justify-center pt-2">
          <Link
            href="/"
            className="inline-flex items-center gap-2 rounded-md border border-border bg-card px-5 py-2.5 text-sm font-bold text-slate-600 transition-colors hover:border-primary/50 hover:text-primary"
          >
