    ...
    <div className="max-w-4xl mx-auto py-10 px-6 print:py-0 print:px-0">
      ...
      >
        <div className="relative flex-1">
          ...
          <input
            className="w-full pl-11 pr-4 py-3 rounded-xl border-2 border-border focus:border-teal-500 outline-none transition-all"
            ...
            <div className="flex items-start justify-between gap-4 flex-wrap">
              <div>
                ...
                <div className="flex items-center gap-2">
                  <h2 className="text-xl font-black text-foreground">{data.request.ref_id}</h2>
                  <button
                    onClick={handleCopy}
