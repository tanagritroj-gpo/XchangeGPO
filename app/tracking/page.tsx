...
function TrackingContent() {
  ...
  return (
    <div className="max-w-5xl mx-auto py-10 px-6">
      <div className="mb-6">
        <a href="/" className="inline-flex items-center gap-1.5 font-bold bg-amber-500 hover:bg-amber-600 text-white px-2 py-2 rounded-lg shadow transition-all duration-200">
