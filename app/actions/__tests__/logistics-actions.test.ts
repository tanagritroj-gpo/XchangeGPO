...
const LOG_STAFF = { id: 'log-1', username: 'log-1', full_name: 'Test Staff', department: 'log', role: 'staff', sale_customer_types: null, sale_provinces: null, email: null };
...
describe('authorization guard', () => {
  it('rejects staff outside the logistics department', async () => {
    mockGetStaffSession.mockResolvedValue({ id: 'wh-1', username: 'wh-1', full_name: 'Test Staff', department: 'wh', role: 'staff', sale_customer_types: null, sale_provinces: null, email: null });
