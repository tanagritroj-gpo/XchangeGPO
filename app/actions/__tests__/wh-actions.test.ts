...
const WH_STAFF = { id: 'wh-1', username: 'wh-1', full_name: 'Test Staff', department: 'wh', role: 'staff', sale_customer_types: null, sale_provinces: null, email: null, signature_url: null };
...
describe('authorization guard', () => {
  ...
  it('rejects staff outside the wh department', async () => {
    mockGetStaffSession.mockResolvedValue({ id: 'csr-1', username: 'csr-1', full_name: 'Test Staff', department: 'csr', role: 'staff', sale_customer_types: null, sale_provinces: null, email: null, signature_url: null });
    seedRequest(1, [{ id: 1, current_status: 'at_warehouse' }]);
    const res = await stampCheckedIn(1, '');
