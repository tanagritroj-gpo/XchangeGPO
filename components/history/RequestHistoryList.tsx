...
function RequestDetailPanel({ requestId, fetchDetail }: { requestId: number; fetchDetail: (requestId: number) => Promise<RequestDetailResult> }) {
            ...
            {pagedHistory.map((req) => {
              ...
              return (
                ...
                >
                  ...
                  {isExpanded && (
                    <RequestDetailPanel requestId={req.id} fetchDetail={fetchDetail} />
                  )}
                </div>
              );
            })}
