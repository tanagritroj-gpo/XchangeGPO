...
export default function Sidebar({ customer }: { customer: any }) {
  ...
  // เพิ่มบรรทัดนี้ครับ! เพื่อดึงค่า ID มาใช้งาน (ลองเช็คดูว่าใน Object customer คือชื่อฟิลด์ไหน)
  // จาก Schema ที่กิตให้มา ถ้าเป็น b2b_customers จะใช้ id หรือ b2b_customer_id
  ...
  return (
    <aside className="h-full flex flex-col p-6 border-r border-teal-50 bg-white/80 backdrop-blur-xl">
      ...
      <nav className="flex-1 space-y-2">
        ...
        {/* ใช้ customerId ที่ประกาศไว้ด้านบน */}
        <Link 
